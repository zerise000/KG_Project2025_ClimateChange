...
\begin{itemize}
	\item In total there are 17 etypes, and among them we count: \textit{MeteorologicalMeasurement},
...
we can identify the missing etypes through the following SPARQL query:
...
the whole situation in the following way: for each CQ we describe the etypes and property
values it should display, the query run on the KG and the actual results:
\begin{itemize}
	
	\item The Competency Question Q1 query can be found here. 
	...
	\item the Competency Question Q2 query can be found here.
	...
	\item The Competency Question Q3 query can be found here.
	...
	\item The Competency Question Q5 query can be found here.
	...
	\item The Competency Question Q6 query can be found here.
	...
	\item The Competency Question Q8 query can be found here.
	...
	\item The Competency Question Q9 query can be found here. 
	...
	\item The Competency Question Q10 query can be found here.
