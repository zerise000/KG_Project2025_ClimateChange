...
(or weather station for polysemy), the region of Trentino and so on, to well-established real-world concepts.
...
Explain where we took data from, how did the data look like, for each entity explain the attribute, the attribute type, why is it common/core/contextual
